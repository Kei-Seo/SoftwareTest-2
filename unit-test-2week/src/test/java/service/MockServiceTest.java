...
public class MockServiceTest {
    ...
    // 1-1 어떠한 포지션을 set해고 미드를 리턴하도록 테스트하세요
    @Test
    public void 어떠한챔피언이름응입력해도무조건미드리턴테스트(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void verifySetPisitionMid(){
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("마드");
    ...
    @Test
    public void shouldThreeTimeRunForChampion(){
        Champion champion = mock(Champion.class);

        champion.setName("원딜");
        champion.setPosition("요네");
    ...
    @Test
    public void shouldPassWhenNeverRunChampSetName(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldOneTimeRunChampGetName(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void 리산드라검색미드포지션과같이가짜객체리턴및맞는지확인(){
        when(mockService.findByName("리산드라")).thenReturn(new Champion("루시안", "바텀", 4));
    ...
    @Test
    public void 두개이상의챔피언을리스트로만들어가져오는메소드(){
        List<Champion> champions = new ArrayList<>();
        champions.add(new Champion("이즈리얼", "원딜", 1));
        champions.add(new Champion("케이틀린", "원딜", 1));
        champions.add(new Champion("베인", "원딜", 1));
    ...
    @Test
    public void 챔피언을검색하면가짜챔피언객체를리턴하고등(){
    ...
    @Test
    public void 여러개이상호춣회수검증(){
        List<Champion> champions = new ArrayList<>();
        champions.add(new Champion("티모", "탐", 3));
